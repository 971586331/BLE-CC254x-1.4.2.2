 ...
 * @{
 */
#define GAPBOND_PAIRING_STATE_STARTED             0x00  //!< Pairing started	配对开始
#define GAPBOND_PAIRING_STATE_COMPLETE            0x01  //!< Pairing complete	配对完成
#define GAPBOND_PAIRING_STATE_BONDED              0x02  //!< Devices bonded		设备绑定
