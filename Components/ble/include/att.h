...
#define ATT_ERROR_RSP                    0x01 //!< ATT Error Response				ATT错误响应
#define ATT_EXCHANGE_MTU_REQ             0x02 //!< ATT Exchange MTU Request			ATT交换MTU请求
#define ATT_EXCHANGE_MTU_RSP             0x03 //!< ATT Exchange MTU Response		ATT交换MTU响应
#define ATT_FIND_INFO_REQ                0x04 //!< ATT Find Information Request		ATT查找信息请求
#define ATT_FIND_INFO_RSP                0x05 //!< ATT Find Information Response	ATT查找信息响应
#define ATT_FIND_BY_TYPE_VALUE_REQ       0x06 //!< ATT Find By Type Vaue Request	ATT接类型查找值请求
#define ATT_FIND_BY_TYPE_VALUE_RSP       0x07 //!< ATT Find By Type Vaue Response	ATT按类型查找值响应
#define ATT_READ_BY_TYPE_REQ             0x08 //!< ATT Read By Type Request			ATT按类型读请求
#define ATT_READ_BY_TYPE_RSP             0x09 //!< ATT Read By Type Response		ATT按类型读响应
#define ATT_READ_REQ                     0x0a //!< ATT Read Request					ATT读请求
#define ATT_READ_RSP                     0x0b //!< ATT Read Response				ATT读响应
#define ATT_READ_BLOB_REQ                0x0c //!< ATT Read Blob Request			ATT读Blob请求
#define ATT_READ_BLOB_RSP                0x0d //!< ATT Read Blob Response			ATT读Blob响应
#define ATT_READ_MULTI_REQ               0x0e //!< ATT Read Multiple Request		ATT读取多个请求	
#define ATT_READ_MULTI_RSP               0x0f //!< ATT Read Multiple Response		ATT读取多个响应
#define ATT_READ_BY_GRP_TYPE_REQ         0x10 //!< ATT Read By Group Type Request	ATT按组类型读请求
#define ATT_READ_BY_GRP_TYPE_RSP         0x11 //!< ATT Read By Group Type Response	ATT按组类型读响应
#define ATT_WRITE_REQ                    0x12 //!< ATT Write Request				ATT写请求
#define ATT_WRITE_RSP                    0x13 //!< ATT Write Response				ATT写响应
#define ATT_PREPARE_WRITE_REQ            0x16 //!< ATT Prepare Write Request		ATT准备写请求
#define ATT_PREPARE_WRITE_RSP            0x17 //!< ATT Prepare Write Response		ATT准备写响应
#define ATT_EXECUTE_WRITE_REQ            0x18 //!< ATT Execute Write Request		ATT执行写请求
#define ATT_EXECUTE_WRITE_RSP            0x19 //!< ATT Execute Write Response		ATT执行写响应
#define ATT_HANDLE_VALUE_NOTI            0x1b //!< ATT Handle Value Notification	ATT处理通知值
#define ATT_HANDLE_VALUE_IND             0x1d //!< ATT Handle Value Indication		ATT处理指示值
#define ATT_HANDLE_VALUE_CFM             0x1e //!< ATT Handle Value Confirmation	ATT处理确认值

#define ATT_WRITE_CMD                    0x52 //!< ATT Write Command				ATT写命令
#define ATT_SIGNED_WRITE_CMD             0xD2 //!< ATT Signed Write Command			ATT写单个命令
